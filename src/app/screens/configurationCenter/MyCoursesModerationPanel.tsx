...
export function MyCoursesModerationPanel({ ctx }: { ctx: MyCoursesBuilderViewContext }) {
  const {
  ...
  return (
    <>
      {builderPanel === "moderation" && (
        <div className="space-y-4">
          <p className="text-xs" style={{ color: P.textMuted }}>
            Manage content moderation and learner discussion settings for this course.
          </p>
          {[
            ["Enable course discussion forum", "Learners can post comments and questions", true],
            [
              "Require creator approval for comments",
              "Comments are held for review before publishing",
              false,
            ],
            [
              "Allow learner reviews and ratings",
              "Learners can submit a star rating and review",
              true,
            ],
            ["Auto-hide flagged content", "Content with 3+ reports is hidden pending review", true],
            [
              "Notify creator of new flags",
              "Creator receives an email when content is flagged",
              true,
            ],
          ].map(([l, d, v]) => (
            <div
